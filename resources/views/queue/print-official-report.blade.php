                ...
                <div class="card-body p-0">
                    <div class="row p-5">
                        ...
                        <div class="col-sm-4">
                            ...
                            <p class="font-weight-bold mb-1"><h2>Berita Acara</h2>  </p>
                            <table style="width:100%">
  <tr>
    <th>Doc Ref #.</th>
    <td><b>{{$doc->doc_ref}}</b></td>
  </tr>
  <tr>
  <th>Date.</th>
...
<p><b>Report</b> : {{$doc->comment}}</p>
                        ...
                        <table  class="table table-bordered m-table"  style="width:100%" > 
							<thead>
						        <tr>
                                  ...
                                  <th class="eighth">Qty</th>
                                  <th class="eighth">Comment</th>
    ...
    <div class="col-sm">
    <p class="text-center">  HANDOVER BY : 
    </div>
    <div class="col-sm">
