	...
	<div class="m-content">
		<div class="m-portlet m-portlet--mobile">
			...
			<div class="m-portlet__body">
				<div class="col-sm-12">
					<form method="post" action="{{url('/add-qcReturn-serialno')}}" id="qcreturn_srno">
					<div class="row">
					<div class="col-sm-12">
					  <div class="row">
						<div class="col-sm-6">
							{!! csrf_field() !!}
							<!-- <input type="hidden" name="return_report_id" class="entry_queue_id"> -->
							<input type="hidden" name="qc_return_id" class="qc_return_id">
...
<script type="text/javascript">
	$(function(){
	    ...
	    $(".btn_add_sn").on("click",function(){
	        $(".new_sn_raw").append('<tr><td><input type="text" name="serial_no[]" class="serial_no"></td></tr>');
	    });
	    $(".document_no").on('change',function(){
	    	...
	    	var qc_return_id = $(this).find('option:selected').attr('data');
	    	// var return_id = $(this).find('option:selected').attr('returnId');
	    	// $(".entry_queue_id").val(e_queue_id);
	    	$(".qc_return_id").val(qc_return_id);
			$.ajax({
				type:"get",
				url: "/returnSerialno-parts/"+qc_return_id,
	    ...
	    $(".product_number").on('change',function(){
	    	...
	    	$.each(responce, function (index, optiondata) {
	    		...
	    		{
	    			$(".qty_qc").val(optiondata.qty_return);
