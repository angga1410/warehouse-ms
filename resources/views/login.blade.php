...
<div class="container">
  ...
  <p>Update in progress.  Please wait until the update process is complete</p>
  <p>@2020 Graha Sumber Prima Elektronik </p>
  </div>
</div> -->
					...
					<div class="m-login__container">
						...
						<div class="m-login__signin">
							<div class="m-login__head">
								<h3 class="m-login__title">Warehouse Management System</h3>
							</div>
							<form class="m-login__form m-form" action="">
								...
								<div class="m-login__form-action">
									...
									<a href="{{url('/view-newUser')}}" class="btn btn-focus m-btn m-btn--pill m-btn--custom m-btn--air  m-login__btn">Sign Up</a>
								</div>
							</form>
						</div>
