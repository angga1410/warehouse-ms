				...
				<div class="m-portlet__head-caption">
					<div class="m-portlet__head-title">
						<h3 class="m-portlet__head-text">
							Create Document for Stock Opname
						</h3>
					</div>
				</div>
			</div>
...
<script src="https://cdnjs.cloudflare.com/ajax/libs/select2/4.0.0/js/select2.full.min.js"></script>
			<div class="m-portlet__body">
				<div class="col-sm-12">
				<form method="post" action="{{url('/stock-opname-save')}}">
					<div class="row">
						...
						<div class="col-sm-12">
							...
							<div class="row">
								...
								<select class="form-control m-input m-input--square" name="done_by" required="true">
								...
								@endforeach
									...
									<div class="col-sm-6">
									<div class="form-group m-form__group">
										<label for="exampleInputEmail1">Supervise By</label>
										<select class="form-control m-input m-input--square" name="supervise_by" required="true">
											@foreach($emp as $get)
							...
							<div class="form-group m-form__group table-responsive">
								...
								<thead>
							        <tr>
							          ...
							          <th class="seventh">Qty Old</th>
									  <th class="seventh">Qty New</th>
	...
	var engine = new Bloodhound({
        ...
        $('#searchProduct1').on('typeahead:selected', function (e, datum) {
            ...
            $("#new_raw_report").append('<tr class"table-replace">'+
                ...
                '<input type="hidden" class="form-control m-input" name="inv_id[]" value="'+datum.wh_id+'" readonly="true" style="width:90px;border:none;">'+
				...
				'<td><input type="number" class="form-control m-input" name="qty_old"  value="'+datum.qty+'" readonly="true" style="width:120px;border:none;"></td>'+
              
				'<td><input type="number" class="form-control m-input"  required name="qty_new[]" style="width:120px;"></td>'+
