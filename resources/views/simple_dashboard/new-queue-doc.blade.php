				...
				<div class="m-portlet__head-caption">
					<div class="m-portlet__head-title">
						<h3 class="m-portlet__head-text">
							Create Document for DO(Titipan)
						</h3>
					</div>
				</div>
			</div>
...
<script src="https://cdnjs.cloudflare.com/ajax/libs/select2/4.0.0/js/select2.full.min.js"></script>
			<div class="m-portlet__body">
				<div class="col-sm-12">
				<form method="post" action="{{url('/save-po-do')}}">
					<div class="row">
						...
						<div class="col-sm-12">
							...
							<div class="row">
								...
								<div class="form-group m-form__group">
										...
										<input class="form-control m-input m-input--square" name="po_number" required="true">
										
									</div>
									<div class="form-group m-form__group">
										<label for="exampleInputEmail1">Customer/Vendor Name</label>
								...
								@endforeach
                                    ...
                                    <div class="form-group m-form__group">
										<label for="exampleInputEmail1">Customer/Vendor Contact</label>
										<select class="form-control m-input m-input--square" name="supplier_contact_id" required="true">
										@foreach($contact as $get)
		...
		$.ajax({
	        ...
	        $.each(data4, function (index, datum) {
	          ...
	          $("#new_raw_report").append('<tr class="report-tr">'+
	            	...
	            	'<td><input type="text" name="qty_pos[]" class="form-control m-input qty_qc" style="width: 100px;"  required="true"></td>'+
					'<td><input type="text" name="um_pr[]" class="form-control m-input qty_qc" style="width: 100px;" value="'+datum.products.default_um+'"  required="true"></td>'+
	...
	var engine = new Bloodhound({
        ...
        $('#searchProduct1').on('typeahead:selected', function (e, datum) {
            ...
            $("#new_raw_report").append('<tr class"table-replace">'+
				...
				'<td><input type="number" class="form-control m-input" max="'+datum.qty+'" name="qty_pos[]" style="width:120px;"></td>'+
