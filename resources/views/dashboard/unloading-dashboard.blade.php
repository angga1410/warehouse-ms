  ...
  <div class="wrapper">
    ...
    <section class="dashboard">
      ...
      <section class="flights">
        <header>
          ...
          <section class="top-flights " >
            <div class="top-flight-card is-active">
              <p class="top-flight-card__price styled-price">{{$poToday}}</p>
              <div class="top-flight-card__info">
                <p class="top-flight-card__heading">PO Hari ini</p>
            ...
            <div class="top-flight-card is-deactive">
              ...
              <div class="top-flight-card__info">
                <p class="top-flight-card__heading">PO Terlambat</p>
            ...
            <!-- /.top-flight-card -->
            <div class="top-flight-card is-active">
              <p class="top-flight-card__price styled-price">{{$doToday}}</p>
              <div class="top-flight-card__info">
            ...
            <div class="top-flight-card is-active">
              <p class="top-flight-card__price styled-price">{{$doToday}}</p>
              <div class="top-flight-card__info">
                <p class="top-flight-card__heading">DO Sedang disiapkan</p>
                <p class="top-flight-card__sub-heading">Dokumen</p>
              </div>
              <!-- /.top-flight-card__info -->
            </div>
        ...
        <div id="slideshow">
        <div>
      <h1>  <p class="flights__total">Purchase Order Hari Ini <span></span></p></h1>
      ...
      <aside class="user-card">
        ...
        <p><span style="font-size: 3em;">Loading Department</span></p>
        </div>
      </aside>
      ...
      <aside class="sidebar">
        ...
        <section class="sidebar-section">
          <h2 class="sidebar-section__heading">Item belum diterima Warehouse</h2>
