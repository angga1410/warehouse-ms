						...
						<div class="col-sm-12">
							...
							<div class="row">
								<div class="col-sm-6">
									...
									<input type="hidden" class="form-control m-input" value="1" name="do" style="border: none;" required="true">
									<div class="form-group m-form__group">
										...
										<option value="{{$schedule['name']}}" data="{{$schedule['id']}}">MR/PPIC/{{ date('Y', strtotime($schedule['createdAt']))  }}/{{$schedule['id']}}</option>
										@endforeach
										</select>
									</div>
									...
									<div class="form-group m-form__group">
										...
										<input class="form-control m-input m-input--square source_type" name="source_type" required="true">
								...
								<div class="col-sm-6">
									...
									<div class="form-group m-form__group">
										...
										<input class="form-control m-input m-input--square" name="requester_id"  required="true">
...
console.log(referenceId);
		$.ajax({
	        ...
	        $.each(data, function (index, datum) {
			  ...
			  '<input type="hidden"  name="warehouse[]" value="'+datum.warehouse+'" readonly="true">'+
